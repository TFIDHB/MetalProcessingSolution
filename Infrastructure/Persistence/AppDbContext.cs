...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UnliquidProduct>().HasData(
            new UnliquidProduct { Id = 1, Name = "Стальной лист ГК 10мм", Description = "Лист горячекатаный, марка Ст3сп, размер 1500х6000.", Price = 450.00m, Quantity = "4 шт" },
            new UnliquidProduct { Id = 2, Name = "Труба профильная 40х40х3", Description = "Остатки после производства металлоконструкций. Длина хлыстов 3м.", Price = 12.80m, Quantity = "25 шт" }
        );
